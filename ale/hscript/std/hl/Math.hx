...
class Math
{
	...
	public static final PI:Float = HlMath.PI;
	public static final NaN:Float = HlMath.NaN;
	public static final POSITIVE_INFINITY:Float = HlMath.POSITIVE_INFINITY;
	public static final NEGATIVE_INFINITY:Float = HlMath.NEGATIVE_INFINITY;
}
#end
